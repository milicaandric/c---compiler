...
public class P5 {
  ...
  public static final int RESULT_ANALYSIS_ERROR = -2;
    ...
    // if it calls the name analyzer and there are no errors
		astRoot.nameAnalysis();  // perform name analysis
    
    if(ErrMsg.getErr()) {
			return P5.RESULT_ANALYSIS_ERROR; // return error if there is an error
		}
